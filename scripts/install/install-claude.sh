...
preflight_clean_item "claude/MANAGED_BY_ROBOREPO.md" "${HOME}/.claude/MANAGED_BY_ROBOREPO.md" || conflict=1
...
link_item_clean "claude/MANAGED_BY_ROBOREPO.md" "${HOME}/.claude/MANAGED_BY_ROBOREPO.md"
...
remove_repo_link "${HOME}/.claude/MANAGED_BY_HARNESS_CONFIGS.md"
