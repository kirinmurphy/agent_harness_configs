...
preflight_clean_item "codex/MANAGED_BY_ROBOREPO.md" "${HOME}/.codex/MANAGED_BY_ROBOREPO.md" || conflict=1
...
link_item_clean "codex/MANAGED_BY_ROBOREPO.md" "${HOME}/.codex/MANAGED_BY_ROBOREPO.md"
...
remove_repo_link "${HOME}/.codex/MANAGED_BY_HARNESS_CONFIGS.md"
